<div>
    ...
    <section class="relative">
        ...
        {{-- Background Blur --}}
        {{-- <div class="absolute -left-20 top-10 h-72 w-72 rounded-full bg-primary/10 blur-3xl"></div>
        <div class="absolute -right-20 bottom-0 h-72 w-72 rounded-full bg-secondary/10 blur-3xl"></div> --}}

        <div class="relative">

            <div class="overflow-hidden rounded-[32px] border border-primary/10 bg-white p-8 shadow-2xl lg:p-14">
                ...
                <div class="text-center">
                    ...
                    <p class="mx-auto mt-6 max-w-3xl text-lg leading-8 text-gray-600">
                        ...
                        If you couldn't find the answer in our FAQs or need personal
                        assistance, feel free to contact us through WhatsApp or Email.
                ...
                <div class="mt-14 grid gap-6 md:grid-cols-3">
                    ...
                    <div class="rounded-3xl border border-primary/10 bg-primary/5 p-6 text-center">

                        <div
                            class="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-primary text-3xl text-white">
                    ...
                    <div class="rounded-3xl border border-secondary/20 bg-secondary/10 p-6 text-center">

                        <div
                            class="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-secondary text-3xl text-white">
                    ...
                    <div class="rounded-3xl border border-green-200 bg-green-50 p-6 text-center">

                        <div
                            class="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-green-600 text-3xl text-white">
                        ...
                        <p class="mt-3 text-gray-600">
                            Professional and respectful assistance.
                        </p>
                ...
                <div class="mt-14 flex flex-col items-center justify-center gap-4 sm:flex-row">
                    ...
                    <a href="https://wa.me/+923333333333" target="_blank"
                        class="inline-flex items-center gap-3 rounded-xl bg-primary px-8 py-4 font-semibold text-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                    ...
                    <a href="mailto:info@waseebrishtay.com"
                        class="inline-flex items-center gap-3 rounded-xl border border-primary px-8 py-4 font-semibold text-primary transition-all duration-300 hover:bg-primary hover:text-white">
